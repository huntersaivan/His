...
namespace E00_Model
{
    public static class cls_STT_KhoaPhong 
    {
        public static string tb_TenBang = "STT_KHOAPHONG";

        public static string col_ID = "ID";
        public static string col_Ma = "MA";
        public static string col_Ten = "TEN";
        public static string col_MaNhom = "MANHOM";
        public static string col_ThamChieu = "THAMCHIEU";
        ...
        public static string col_MaNhomKV = "MANHOMKV";
