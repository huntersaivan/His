...
namespace E00_Model
{
    public static class cls_D_DoiTuongDuyet
    {
        public static string tb_TenBang = "AD_DOITUONGDUYET";

        public static string col_ID = "ID";
        public static string col_Ma = "MA";
        public static string col_Ten = "TEN";
        public static string col_Loai = "LOAI";
        public static string col_NguyenTac = "NGUYENTAC";
        public static string col_GhiChu = "GHICHU";
        public static string col_Stop = "STOP";
